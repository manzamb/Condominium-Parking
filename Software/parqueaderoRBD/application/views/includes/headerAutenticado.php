...
<html class="no-js">
    ...
    <body>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li><?php echo anchor('../index.php/administrador', 'Inicio'); ?> </li>
                                        ...
                                        <li><?php echo anchor('direccionamiento/reportes', 'Reportes'); ?> </li>
                                        <li><?php echo anchor('direccionamiento/multas', 'Multas'); ?> </li>
                                        <li><?php echo anchor('direccionamiento/visitas', 'Visitas'); ?> </li>
        ...
        <div id="modales">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <table id="tablaReporte"class="table tablet-striped table-bordered table-hover table-condense">
                             ...
                             <button type="button" id="btnEntarVisita" class="btn btn-primary" data-toggle='modal'  onclick="generar_reportes()" >Generar</button>
                            <button type="button"  class="btn btn-success"  data-dismiss="modal" id="btnSiguiemteNuevoProyeco">Salir</button>
            ...
            <div class="modal fade" id="vReporteAnio" tabindex="-1" role="dialog" aria-labelledby="titulo-modal5" aria-hidden="true">
                ...
                <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                        ...
                        <!--contenido de la emergente-->
                        <div class="modal-footer">
                            <table id="tablaReporteAnio"class="table tablet-striped table-bordered table-hover table-condense">
                                <thead>
                                    <tr>
                                        <th>Dirección de casa</th>
                                        <th>Entradas totales</th>
                             ...
                             <button type="button" id="btnEntarVisita" class="btn btn-primary" data-toggle='modal'  onclick="generar_reportes_anio()" >Generar</button>
                            <button type="button"  class="btn btn-success"  data-dismiss="modal" id="btnSiguiemteNuevoProyeco">Salir</button>
            ...
            <div class="modal fade" id="vReporteMes" tabindex="-1" role="dialog" aria-labelledby="titulo-modal5" aria-hidden="true">
                ...
                <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                        ...
                        <!--contenido de la emergente-->
                        <div class="modal-footer">
                            <table id="tablaReporteMes"class="table tablet-striped table-bordered table-hover table-condense">
                                <thead>
                                    <tr>
                                        <th>Dirección de casa</th>
                                        <th>Entradas totales</th>
                             ...
                             <button type="button" id="btnEntarVisita" class="btn btn-primary" data-toggle='modal'  onclick="generar_reportes_mes()" >Generar</button>
                            <button type="button"  class="btn btn-success"  data-dismiss="modal" id="btnSiguiemteNuevoProyeco">Salir</button>
